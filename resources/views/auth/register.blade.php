                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="nombre" type="text"
                                   ...
                                   autofocus  pattern="^[a-zA-Z]{3,9}$" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   value="{{ old('email') }}"
                                   pattern=".+@gmail\.com" required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="contrasena" type="password"
                                   ...
                                   placeholder="Set account password" name="password" tabindex="2" pattern="^(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}$" required>
                            <div class="invalid-feedback">
