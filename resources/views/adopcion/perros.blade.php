...
<h2 class ="m-10 text-3x1 text-center p-7 text-blue-900">Listado de perros</h2>
</div>
<div style="text-align:right; width:100%;">

    @can('crear-animales')
    <a href="{{ route('adopcion.anadir_perros') }}">
            <button name='selecionar 'class="bg-green-500 hover:bg-green-500 text-white font-bold py-2 px-4 rounded">Añadir perro</button>
            </a>
            @endcan
</div>
